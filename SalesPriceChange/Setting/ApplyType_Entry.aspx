<%@ Page Title="" Language="C#" MasterPageFile="~/SalePriceMaster.Master" AutoEventWireup="true" CodeBehind="ApplyType_Entry.aspx.cs" Inherits="SalesPrice.Setting.ApplyDate_Entry" %>
    ...
    <div class="container" style="width:100%">
        ...
        <div class="">
            <div class="panel panel-info panel-table" style="margin-left:-1%; margin-right:-1%; width:100%">
                <div class="panel-heading" style ="background-color :#337ab7; color:white;">
                    <div class="row">
                        <div class="col col-xs-6">
                            <h1 class="panel-title"><b style="font-weight:bold;  font-size:20px;">申請区分一覧</b></h1>
                        </div>
                    </div>
                    <br />
                </div>
                ...
                <asp:Label runat="server" ID="lblsr1" Text="申請区分-" Font-Bold="true" Font-Size="16px"></asp:Label>
                 ...
                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  ...
                  <div class="panel-body" style ="padding-top :3px">
                    ...
                    AllowPaging="true" OnPageIndexChanging="gvApplyType_PageIndexChanging" HeaderStyle-CssClass="ckmdiv" PagerSettings-Mode="NumericFirstLast" PageSize="8" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <FooterTemplate>
                                                    <asp:TextBox Width="90%" style="text-align:right" onkeypress="return isNumber(event)" runat="server" ID="txtFooterPreference"></asp:TextBox>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderStyle Width="75%" />
                                                <HeaderTemplate>
                                                    <asp:Label runat="server" ID="lblHeaderDescription" Text="申請区分"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
