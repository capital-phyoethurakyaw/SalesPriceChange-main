<%@ Page Title="" Language="C#" MasterPageFile="~/SalePriceMaster.Master" AutoEventWireup="true" CodeBehind="Selling_Price Unit.aspx.cs" Inherits="SalesPrice.Setting.Selling_Price_Unit" %>
    ...
    <div class="container" style="width:100%">
        ...
        <div class="">
            <div class="panel panel-info panel-table" style="margin-left:-1%; margin-right:-1%; width:100%">
                <div class="panel-heading" style ="background-color :#337ab7; color:white;">
                    <div class="row">
                        <div class="col col-xs-6">
                            <h1 class="panel-title"><b style="font-weight:bold; font-size:20px;">売価単位一覧</b></h1>
                        </div>
                    </div>
                    <br />
                </div>
               ...
               <asp:Label runat="server" ID="lblsr5" Text="売価単位" Font-Bold="true" Font-Size="16px"></asp:Label> 
                  ...
                  <div class="panel-body" style ="padding-top :3px">
                    <div class="row">
                        <div class="form-group col-xs-8"  style="vertical-align:middle">                 
                                    ...
                                    <asp:GridView ShowFooter="true" runat="server" ID="gvSellingPriceUnit" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" HeaderStyle-BackColor="#337ab7" HeaderStyle-ForeColor ="White"
                                  HeaderStyle-CssClass="ckmdiv"    AllowPaging="true" OnPageIndexChanging="gvSellingPriceUnit_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PageSize="8"
                                        >
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <asp:Label runat="server" ID="lblHeaderDescription" Text="売価単位"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                    ...
                    <div class="row">
                        <div class="col ">
                            <div>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <%--   Page Size:
                                <asp:DropDownList runat="server" ID="ddlPageSize" Visible="false" AutoPostBack ="true" Height="30px" OnSelectedIndexChanged="gvSellingPrice_Indexchanged" Width="50px" >
