<%@ Page Language="C#" MasterPageFile="~/SalePriceMaster.Master" AutoEventWireup="true" CodeBehind="Category_Entry.aspx.cs" Inherits="SalesPrice.Setting.Category_Entry" %>
    ...
    <div class="container" style="width:100%">
        ...
        <div class="">
            <div class="panel panel-info panel-table" style="margin-left:-1%; margin-right:-1%; width:100%">
                <div class="panel-heading" style ="background-color :#337ab7; color:white;">
                    <div class="row">
                        <div class="col col-xs-6">
                            <h1 class="panel-title"><b style="font-weight:bold;  font-size:20px;">カテゴリエントリ一覧</b></h1>
                        </div>
                    </div>
                    <br />
                </div>
                ...
                <asp:Label runat="server" ID="lblsr1" Text="カテゴリエントリ-" Font-Bold="true" Font-Size="16px"></asp:Label>
<asp:TextBox ID="txtSiteIDSearch2"   runat="server"  CssClass="col1" onkeypress="return allowOnlyNumber(event);"></asp:TextBox>
                 ...
                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  ...
                  <div class="panel-body" style ="padding-top :3px">
                    <div class="row">
                     ...
                     <asp:GridView ShowFooter="true" runat="server" ID="gvApplyType" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" HeaderStyle-BackColor="#337ab7" HeaderStyle-ForeColor ="White" 
                                 HeaderStyle-CssClass="ckmdiv"     AllowPaging="true" OnPageIndexChanging="gvApplyType_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PageSize="8" 
                                        >
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <asp:Label runat="server" ID="lblHeaderDescription" Text="カテゴリエントリ"></asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <a id ="btndel"  class="btn btn-danger btn-xs" runat ="server" onserverclick="btnDelete_Click" >
                    ...
                    <div class="row">
                        <div class="col ">
                            <div>
                                    <div class="pull-left">
                                        Go To:
                                        <asp:TextBox Width="35px"  runat="server" ID="txtGoto" onkeypress="return isNumber(event)"  CssClass="col1" Height="34px" style="border:1px solid grey; border-radius:4.5px; background-color :#F5F5F5; vertical-align:middle"></asp:TextBox>                              
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <%-- Page Size:
                                <asp:DropDownList runat="server" ID="ddlPageSize"  AutoPostBack="true" Height="30px" OnSelectedIndexChanged="gvApplyType_Indexchanged" Width="50px" >
