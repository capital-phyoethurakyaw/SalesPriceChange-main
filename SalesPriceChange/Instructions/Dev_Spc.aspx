<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dev_Spc.aspx.cs" Inherits="SalesPrice.Instructions.Dev_Spc" MasterPageFile="~/SalePriceMaster.Master" %>--%>
<!DOCTYPE html>
...
<head id="Head1" runat="server">
  ...
  <%--  <link href="../Styles/Common.css" rel="stylesheet" /><%--<compilation debug="true" targetFramework="4.0"/>--%>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 760px), (min-device-width: 768px) and (max-device-width: 1024px) {
            ...
            span#lblenddt.label-black {
                width:110px !important;

            }

            span#lblApplyDate.label-black {
                width:105px !important;
            }
            span#Label4.label-black {
                width:105px !important;
            }
            .beta2 {
                margin-left:-2%;
	...
	.gamma_a td:nth-of-type(2):before { content: ""; }
            ...
            div#ddlSellingPrice_chosen {
                width:220px !important;
            }
            div#ddlCostUnit_chosen {
                 width:220px !important;
            }
            .zeta {
    ...
    /*.gam
        ...
        div#ddlSalePriceType_chosen {
            left:-1%;
            
        }
        div#ddlInventoryType_chosen {
              left:-1%;
    ...
    <body>
        <form runat="server">
                  <cc1:ToolkitScriptManager AsyncPostBackTimeout="60000" ID="ToolkitScriptManager1" runat="server"></cc1:ToolkitScriptManager>
            ...
            <div class="panel panel-info panel-table">
                  ...
                  <div class="panel-body">                  
                     ...
                     <div class="row beta1" >
                            ...
                            <div id="Div1" class="input-group date form_date  " data-date="" data-date-format="yyyy//mm/dd" data-link-field="dpDelivery" data-link-format="yyyy-mm-dd" style="float:left">
                                  <input runat="server" type="text"  maxlength="10" id="dpApplyDate" onkeydown="return DateFormat(this, event.keyCode)" style="line-height:0 !important; padding-top:initial; height:30px; width:150px;  border:1px solid black; border-radius:1.5px; text-align:center;float:left"/>
               ...
               <%--     Start Date and end Date--%>
                     ...
                     <div runat="server"  class="alpha1" >
                    <div >
                        <table class="alpha">
                            <tr>
                            <th>
                                <div runat="server" style="float:left"> <asp:Label runat="server" ID="lblstdate" Text="開始日" Height="30px" Width="100px" CssClass="label-black" style="float:left;"></asp:Label></div>
                                    ...
                                    <div runat="server" style="float:left">
                                     <div runat="server" style="float:left">
                                       <asp:Label runat="server" ID="lblenddt" Text="終了日" Height="30px"  CssClass="label-black" Style="float:left;width:100px"></asp:Label>
                                         </div>  <div  id="Div3" class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy//mm/dd" data-link-field="dpDelivery" runat="server" data-link-format="yyyy-mm-dd" style="float:left; width:120px; margin-left:-10px">
                    ...
                    <div style="clear:both"></div>
                     ...
                     <div class="" style="margin-top:10px">
                        <div class="" style ="width:800px">
                            ...
                            <div class="theta" runat="server" > </div>
                                <div style="float:left">
                    ...
                    <div id="Div4" runat="server" style=" height:auto" class="first_bg">
                     ...
                     <%--       <table>
                                    ...
                                    <table  style="margin-left:15px; margin-top:10px; border:5px solid none">
                                        <tr >
                                            ...
                                            <td>
                                                ...
                                                <asp:Button runat="server" ID="btnupload"   CssClass="cappa"  Text="Upload" Height="30px" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top:10px">
                                                <asp:Button runat="server" CssClass="cappa" ID="btndown"  Text="Download" Height="30px"/>
                                            </td>
                                        </tr>
                                    </table>
                      ...
                      <div style="clear:both"></div>      
                    <div style ="height:auto;" class="second_bg">
                    ...
                    <div class="row" style="padding-top:10px">
                     ...
                     <div style="padding-top:10px;  vertical-align:middle" class="input-group">        
                        <div style="float:left">
                         ...
                         <textarea id="Textarea1" runat="server" class="form-control" style="height:60px;max-height:60px;min-height:60px;max-width:900px " aria-label="With textarea"></textarea>
                   ...
                   <%--<div class="panel-footer">--%>
                     <div class="col ">
                            <div class="text-center">
                                <button id="btnSave" type="button" class="btn btn-primary" runat ="server"  style="margin-top:5px;width:120px" validationgroup ="ControlFrame" >
                                    <span class="glyphicon glyphicon-save"
                                          aria-hidden="true"></span>
                                    <asp:Label ID="lblSave" runat="server" Text= "登録" ></asp:Label>
                                 </button>  
                                <button id="btnCopy" type="button" visible ="false"  class="btn btn-primary" runat ="server"  style="margin-top:5px;width:120px;">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
           <button type="button" runat="server" id="btnConfirmDelete" class="btn btn-default" data-dismiss="modal" >削除</button>
