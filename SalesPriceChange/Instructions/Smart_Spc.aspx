<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Smart_Spc.aspx.cs" Inherits="SalesPrice.Instructions.Smart_Spc" MasterPageFile="~/SalePriceMaster.Master" %>
            ...
            <div class="panel panel-info panel-table">
               ...
               <%--     Start Date and end Date--%>
                    ...
                    <div >
                      ...
                      <div id="Div4x" class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy//mm/dd" data-link-field="dpDelivery" runat="server" data-link-format="yyyy-mm-dd" style="float:left; width:120px">
                                    ...
                                    <div id="Div5" runat="server" style="float:left">
                                     <div id="Div6" runat="server" style="float:left">
                                       <asp:Label runat="server" ID="lblenddt" Text="終了日" Height="30px"  CssClass="label-black" Style="float:left;width:100px"></asp:Label>
                                         </div>  <div  id="Div7" class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy//mm/dd" data-link-field="dpDelivery" runat="server" data-link-format="yyyy-mm-dd" style="float:left; width:120px; margin-left:-10px">
                         ...
                         <%--       <td style="padding-left:15px;width:520px;padding-top:10px;">--%>
                            ...
                            <tr>--%>
                               ...
                               <div style="float:left;margin-top:1%" class="xai" >
                                    ...
                                    <div id="Div13x" runat="server" class="pull-left"><uc1:IntegerTextbox runat="server" ID="txtpurchaseprice" instyle=" height:30px;border:1px solid black; text-align:initial" /></div>
